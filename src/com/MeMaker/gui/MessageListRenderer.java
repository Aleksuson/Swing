...
public class MessageListRenderer implements ListCellRenderer {
    ...
    public MessageListRenderer() {
        ...
        label.setFont(Utils.createFont("/com/MeMaker/fonts/CrimewaveBB.ttf").deriveFont(Font.PLAIN,20));


        selectedColor = new Color(210,210,255);
        normalColor = Color.white;

        label.setIcon(Utils.createIcon("/com/MeMaker/images/Information24.gif"));
